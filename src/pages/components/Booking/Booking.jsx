  ...
  return (
    <>
      ...
      <section className={props.class || zhsection}>
        <div className={props.ChosingLan === 'en' ? "zh-booking-parent" : "zh-booking-parentAR"}>
          ...
          <div className='zh-info'>
            <div className='zh-title'>
              ...
              {props.btn && <div className='zh-btn-price'>
                ...
                <div className='FQcardPricsflex'><p>{props.price}$</p><span>{props.ChosingLan === 'en' ? "Per Night" : "لكل ليلة"}</span></div>
              </div>}
            </div>
          </div>
        </div>
